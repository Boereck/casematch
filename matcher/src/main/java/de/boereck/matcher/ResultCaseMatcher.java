...
/**
 * <p>
 * This interface is used to define cases that can be used to match a given object and define associated functions that are
 ...
 * <ul>
 * <li> {@link de.boereck.matcher.ResultCaseMatcher#otherwise(java.util.function.Function) otherwise(Function)}</li>
 * <li> {@link de.boereck.matcher.ResultCaseMatcher#otherwise(Object) otherwise(Object)}</li>
 * <li> {@link de.boereck.matcher.ResultCaseMatcher#otherwiseThrow(java.util.function.Supplier) otherwiseThrow(Supplier)}</li>
 * <li> {@link de.boereck.matcher.ResultCaseMatcher#ifResult(java.util.function.Consumer) ifResult(Consumer)}</li>
 * <li> {@link de.boereck.matcher.ResultCaseMatcher#orElse(Object) orElse(Object)}</li>
 * <li> {@link de.boereck.matcher.ResultCaseMatcher#orElse(java.util.function.Supplier) orElse(Supplier)}</li>
 * <li> {@link de.boereck.matcher.ResultCaseMatcher#orElseThrow(java.util.function.Supplier) orElseThrow(Supplier)}</li>
 * </ul>
...
public interface ResultCaseMatcher<I, O> {
     ...
     * checking for. The result of the function will be the result of the case match.
     *
     ...
     */
    public abstract <T> ResultCaseMatcher<I, O> caseOf(Class<T> clazz, Function<? super T, ? extends O> f) throws NullPointerException;
     ...
     * @throws NullPointerException might be thrown if either parameter {@code clazz} or {@code f} is {@code null}.
     */
    public abstract <T> ResultCaseMatcher<I, O> caseOf(Class<T> clazz, Predicate<? super T> condition, Function<? super T, ? extends O> f) throws NullPointerException;
     ...
     */
    public abstract ResultCaseMatcher<I, O> caseOf(Predicate<? super I> p, Function<? super I, ? extends O> f) throws NullPointerException;
     ...
     */
    public abstract ResultCaseMatcher<I, O> caseOf(BooleanSupplier s, Function<? super I, ? extends O> f) throws NullPointerException;
     ...
     * overall result of the case match.
     *
     ...
     * @throws NullPointerException might be thrown if either parameter {@code p} or {@code f} is {@code null}.
     */
    public abstract <T> ResultCaseMatcher<I, O> caseObj(Function<? super I, Optional<T>> p, Function<? super T, ? extends O> f) throws NullPointerException;
     ...
     * be the overall result of the case match.
     *
     * @param p function that returns an optional that indicates if the case is a match, when the optional is not empty.
     * @param f will be called if the function {@code p} returns an non-empty optional and the case is determined to be the
     ...
     * matching case returned null, use {@link de.boereck.matcher.ResultCaseMatcher#orElseThrow(java.util.function.Supplier) orElseThrow(Supplier)}.
     *
