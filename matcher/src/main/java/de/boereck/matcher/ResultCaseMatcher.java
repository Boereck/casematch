 ...
 * @author Max Bureck
 * @param <I>
 *            type of the input object to be matched
 * @param <O>
...
public interface ResultCaseMatcher<I, O> {
     ...
     * 
     * @param clazz
     *            Type the input object is checked to be instance of
     * @param f
     *            function that will be executed (with input object as parameter) when the case is determined to be the
     ...
     *             might be thrown if either parameter {@code clazz} or {@code f} is {@code null}.
     */
     ...
     * @return instance of ResultCaseMatcher (maybe same as same object as this) to define further cases.
     * @throws NullPointerException
     *             might be thrown if either parameter {@code p} or {@code f} is {@code null}.
     */
     ...
     * @return instance of ResultCaseMatcher (maybe same as same object as this) to define further cases.
     * @throws NullPointerException
     *             might be thrown if either parameter {@code s} or {@code f} is {@code null}.
     */
     ...
     * @throws NullPointerException
     *             might be thrown if parameter {@code f} is {@code null}.
     */
