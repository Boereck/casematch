...
/**
 * This extended {@link IntPredicate} provides more default methods as boolean operators.
 * <style type="text/css">
...
public interface AdvIntPredicate extends IntPredicate {
     ...
     */
    default <O> IntFunction<Optional<O>> ifThen(IntFunction<O> f) {
     ...
     * @throws NullPointerException if {@code f} is {@code null}.
     */
    default <O> IntFunction<Optional<O>> ifThenFlat(IntFunction<Optional<O>> f)throws NullPointerException {
        Objects.requireNonNull(f);
     ...
     *
     * @return result of {@link AdvIntPredicate#negate() negate()}.
     */
     ...
     *     </tr>
     * </table>
     * @see IntPredicate#or(IntPredicate)
