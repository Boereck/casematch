 ...
 * <li> {@link de.boereck.matcher.eager.EagerResultDoubleCaseMatcher#otherwise(Object) otherwise(Object)}</li>
 * <li> {@link de.boereck.matcher.eager.EagerResultDoubleCaseMatcher#otherwiseThrow(java.util.function.Supplier) otherwiseThrow(Supplier)}</li>
 * <li> {@link de.boereck.matcher.eager.EagerResultDoubleCaseMatcher#ifResult(java.util.function.Consumer) ifResult(Consumer)}</li>
 * <li> {@link de.boereck.matcher.eager.EagerResultDoubleCaseMatcher#orElse(Object) orElse(Object)}</li>
