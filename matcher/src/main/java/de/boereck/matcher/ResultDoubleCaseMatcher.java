...
/**
 * <p>
 * This interface is used to define cases that can be used to match a given double value and define associated functions that
 ...
 * <ul>
 * <li> {@link de.boereck.matcher.ResultDoubleCaseMatcher#otherwise(java.util.function.DoubleFunction) otherwise(DoubleFunction)}</li>
 * <li> {@link de.boereck.matcher.ResultDoubleCaseMatcher#otherwise(Object) otherwise(Object)}</li>
 * <li> {@link de.boereck.matcher.ResultDoubleCaseMatcher#otherwiseThrow(java.util.function.Supplier) otherwiseThrow(Supplier)}</li>
 * <li> {@link de.boereck.matcher.ResultDoubleCaseMatcher#ifResult(java.util.function.Consumer) ifResult(Consumer)}</li>
 * <li> {@link de.boereck.matcher.ResultDoubleCaseMatcher#orElse(Object) orElse(Object)}</li>
 * <li> {@link de.boereck.matcher.ResultDoubleCaseMatcher#orElse(java.util.function.Supplier) orElse(Supplier)}</li>
 * <li> {@link de.boereck.matcher.ResultDoubleCaseMatcher#orElseThrow(java.util.function.Supplier) orElseThrow(Supplier)}</li>
 * </ul>
 * Sub-types may define more closing methods. The effects of closing methods are always taking effect after all cases were
 * checked.
 * </p>
 *
 * @param <O> type of the result object returned from the case match
 * @author Max Bureck
 */
public interface ResultDoubleCaseMatcher<O> {
     ...
     *
     * @param p        Checking predicate that defines if the case is a match, when provided with the input value.
     ...
     */
    public abstract ResultDoubleCaseMatcher<O> caseOf(DoublePredicate p, DoubleFunction<? extends O> f) throws NullPointerException;
     ...
     */
    public abstract ResultDoubleCaseMatcher<O> caseOf(BooleanSupplier s, DoubleFunction<? extends O> f) throws NullPointerException;
     ...
     * @throws NullPointerException might be thrown if either parameter {@code p} or {@code f} is {@code null}.
     */
    public abstract ResultDoubleCaseMatcher<O> caseOf(boolean test, DoubleFunction<? extends O> f) throws NullPointerException;
     ...
     * @throws NullPointerException might be thrown if either parameter {@code p} or {@code f} is {@code null}.
     */
    public abstract <T> ResultDoubleCaseMatcher<O> caseObj(DoubleFunction<Optional<T>> p, Function<? super T, ? extends O> f) throws NullPointerException;
     ...
     * @throws NullPointerException might be thrown if either parameter {@code p} or {@code f} is {@code null}.
     */
    public abstract <T> ResultDoubleCaseMatcher<O> caseInt(DoubleFunction<OptionalInt> p, IntFunction<? extends O> f) throws NullPointerException;
     ...
     * @throws NullPointerException might be thrown if either parameter {@code p} or {@code f} is {@code null}.
     */
    public abstract <T> ResultDoubleCaseMatcher<O> caseLong(DoubleFunction<OptionalLong> p, LongFunction<? extends O> f) throws NullPointerException;
     ...
     * @throws NullPointerException might be thrown if either parameter {@code p} or {@code f} is {@code null}.
     */
    public abstract <T> ResultDoubleCaseMatcher<O> caseDouble(DoubleFunction<OptionalDouble> p, DoubleFunction<? extends O> f) throws NullPointerException;
     ...
     * the result value.
     *
     * @param consumer will be called with the result of the case match if the result was not {@code null}.
     ...
     *
     * @param o will be returned if there was no prior match. This value might be null.
     ...
     *
     * @param supplier will supply the result value if there was no prior match. This value might be null. The supplier itself
     ...
     * matching case returned null, use {@link de.boereck.matcher.ResultDoubleCaseMatcher#orElseThrow(java.util.function.Supplier) orElseThrow(Supplier)}.
     *
     ...
     * @see de.boereck.matcher.ResultDoubleCaseMatcher#orElseThrow(java.util.function.Supplier).
     */
     ...
     *
     * @param o object that will be returned if there was no match, or the return value from match was {@code null}. This
     ...
     * never be {@code null}.
     *
     * @param supplier provides the value to be returned if there was no match or result of match was {@code null}. This parameter
     ...
     * @throws X                    Will be thrown if there was no match or the match provided a {@code null} result.
