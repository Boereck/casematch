...
public interface NoResultCaseMatcher<I> {
     ...
     * 
     * @param p
     *            Checking predicate that defines if the case is a match, when provided with the input object.
     * @param consumer
     ...
     * @return instance of NoResultCaseMatcher to define further cases.
     * @throws NullPointerException
     *             might be thrown if either parameter {@code s} or {@code consumer} is {@code null}.
     */
     ...
     * @throws NullPointerException
     *             might be thrown if parameter {@code exSupplier} is {@code null} or if it provides {@code null} as a value.
     */
