...
/**
 * <p>
 * This interface is used to define cases that can be used to match a given int value and define associated actions that are
 ...
 * <ul>
 * <li> {@link de.boereck.matcher.NoResultIntCaseMatcher#otherwise(java.util.function.IntConsumer) otherwise(Consumer)}</li>
 * <li> {@link de.boereck.matcher.NoResultIntCaseMatcher#otherwiseThrow(java.util.function.Supplier) otherwiseThrow(Supplier)}</li>
 * </ul>
...
public interface NoResultIntCaseMatcher {
     ...
     */
    public abstract <T> NoResultIntCaseMatcher caseOf(int reference, IntConsumer consumer) throws NullPointerException;
