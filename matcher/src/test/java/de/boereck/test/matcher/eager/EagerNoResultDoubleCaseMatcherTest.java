...
public class EagerNoResultDoubleCaseMatcherTest {


    private static final DoubleConsumer fail = o -> fail();
    ...
    ////////////////////////////////////////////////////////////////////////
    // Test of EagerNoResultDoubleCaseMatcher#caseOf(IntPredicate, IntConsumer) //
    ////////////////////////////////////////////////////////////////////////

    @Test
    public void testCaseOfGetsSameObjectAsInput() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).caseOf(i -> true, s -> success.set(true));
    ...
    public void testCaseOfPredicate() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).caseOf(s -> true, s -> success.set(true));
        assertTrue(success.get());
    }

    @Test
    public void testCaseOfPredicateNoMatch() {
        match(0.0).caseOf(s -> false, s -> fail());
    }
    ...
    public void testCaseOfPredicateNullPointer1() {
        match(0.0).caseOf((DoublePredicate) null, s -> fail());
        fail();
    }

    @Test(expected = NullPointerException.class)
    public void testCaseOfPredicateNullPointer2() {
        match(0.0).caseOf(s -> true, null);
        fail();
    }
    ...
    public void testCaseOfBooleanSupplier() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).caseOf(() -> true, s -> success.set(true));
        assertTrue(success.get());
    }

    @Test
    public void testCaseOfBooleanSupplierNoMatch() {
        match(0.0).caseOf(() -> false, fail);
    }
    ...
    public void testCaseOfBooleanSupplierNullPointer1() {
        match(0.0).caseOf((BooleanSupplier) null, fail);
        fail();
    }

    @Test(expected = NullPointerException.class)
    public void testCaseOfBooleanSupplierNullPointer2() {
        match(0.0).caseOf(() -> true, null);
        fail();
    }
    ...
    public void testCaseIsBool() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).caseIs(true, () -> success.set(true));
        assertTrue(success.get());
    }

    @Test
    public void testCaseIsBooleanNoMatch() {
        match(0.0).caseIs(false, failR);
    }
    ...
    public void testCaseIsPredicateBool() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).caseIs(s -> true, () -> success.set(true));
        assertTrue(success.get());
    }

    @Test
    public void testCaseIsPredicateBooleanNoMatch() {
        match(0.0).caseIs(s -> false, failR);
    }
    ...
    public void testCaseOfFunction() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).caseObj(Optional::ofNullable, s -> success.set(true));
    ...
    public void testCaseOfFunctionNoMatch() {
        ...
        match(0.0).caseObj(s -> Optional.empty(), s -> success.set(false));
    ...
    public void testCaseOfFunctionNullPointer2() {
        match(0.0).caseObj(s -> Optional.empty(), null);
        fail();
    }
    ...
    public void testCaseIntFunctionNoMatch() {
        match(0.0).caseInt(s -> OptionalInt.empty(), s -> fail());
    }
    ...
    public void testCaseIntFunctionCheckParameter() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).caseInt(l -> OptionalInt.of(42), in -> success.set(in == 42));
    ...
    public void testCaseIntFunctionNullPointer2() {
        match(0.0).caseInt(s -> OptionalInt.empty(), null);
        fail();
    }
    ...
    public void testCaseLongFunctionNoMatch() {
        match(0.0).caseLong(s -> OptionalLong.empty(), s -> fail());
    }
    ...
    public void testCaseLongFunctionCheckParameter() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).caseLong(d -> OptionalLong.of(42), in -> success.set(in == 42L));
    ...
    public void testCaseLongFunctionNullPointer2() {
        match(0.0).caseLong(s -> OptionalLong.empty(), null);
        fail();
    }
    ...
    public void testCaseDoubleFunctionNoMatch() {
        match(0.0).caseDouble(s -> OptionalDouble.empty(), s -> fail());
    }
    ...
    public void testCaseDoubleFunctionNullPointer2() {
        match(0.0).caseDouble(s -> OptionalDouble.empty(), null);
        fail();
    }
    ...
    public void testOtherwise() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).otherwise(s -> success.set(true));
    ...
    public void testOtherwiseThrow() {
        AtomicBoolean success = new AtomicBoolean(false);
        match(0.0).otherwiseThrow(NoSuchElementException::new);
